  ...
  return (
    <>
      <body className="app">
          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse d-md-flex justify-content-md-between ms-md-5 " id="navbarNav">
              <ul className="navbar-nav d-md-flex gap-md-5 px-3 py-1" id="left-nav">
                ...
                <li className="nav-item fw-bold mx-md-4">
                  <button onClick={() => setShowModal(true)} className="nav-link btn btn-link">Sign Up</button>
                </li>
              </ul>
        ...
        {/* fetch the num  */}
        <p className="text-center mt-5" id="headline">Join the growing community of <span id="dynamic-registered">{registeredCount}</span> interested learners</p>
        ...
        {showModal && (
          <div style={modalStyles.modal} ref={modalRef} onClick={closeModal}>
            <div style={modalStyles.modalContent}>
              <button style={modalStyles.closeButton} onClick={() => setShowModal(false)}>&times;</button>
              <h2 style={{color: '#1E400F', fontFamily:'helvetica', fontWeight:'bolder', marginBottom: '0px'}}>Interested?</h2>
              <h3 style={{color: '#1E400F', opacity: '80%', marginBottom: '30px',fontSize:"1.25rem", fontFamily:'helvetica', fontWeight:'bold'}}>Let us know.</h3>
              <form onSubmit={handleSubmit} style={modalStyles.form}>
                ...
                <input
                  ...
                  style={modalStyles.input}
                />
                <button type="submit" style={modalStyles.submitButton}>Join ScrollWise</button>
              </form>
            </div>
          </div>
        )}
